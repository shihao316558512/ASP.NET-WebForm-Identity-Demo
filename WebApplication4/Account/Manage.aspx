<%@ Page Title="管理帐户" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="WebApplication4.Account.Manage" %>
                ...
                <dl class="dl-horizontal">
                    ...
                    <%--
                       ...
                       有关如何设置此 ASP.NET 应用程序以支持使用
                        SMS 进行双因素身份验证的详细信息，请参阅<a href="https://go.microsoft.com/fwlink/?LinkId=403804">此文章</a>。
                        在设置双因素身份验证后，取消评论以下块
                    --%>
                    <%--
                    <dt>电话号码:</dt>
